...
# 字典传参
num = {
    1: ['10001', '123', 'Mike', '2017-5-6', 'lalalalal'],
    2: ['10002', '123', 'Sam', '2018-5-6', 'lalalalal'],
    3: ['10003', '123', 'hong', '2019-5-6', 'lalalalal'],
    4: ['10004', '123', 'xiao', '2019-5-6', 'lalalalal']
}
data_pd = pandas.DataFrame.from_dict(num, orient='index', columns=['Songs', 'Albums', 'Artists', 'date', 'Lyrics'])
